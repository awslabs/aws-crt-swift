...
extension IStreamable {
  ...
  public func seek(offset: UInt64, streamSeekType: StreamSeekType) throws {
    throw CommonRunTimeError.crtError(
      CRTError(code: Int32(AWS_IO_STREAM_SEEK_UNSUPPORTED.rawValue)))
  }

  public func length() throws -> UInt64 {
    throw CommonRunTimeError.crtError(
      CRTError(code: Int32(AWS_IO_STREAM_GET_LENGTH_UNSUPPORTED.rawValue)))
  }
}
