...
public final class ClientBootstrap {
    ...
    public init(eventLoopGroup elg: EventLoopGroup,
        ...
        let shutdownCallbackCore = ShutdownCallbackCore(shutdownCallback)?.getRetainedShutdownOptions()
        var options = aws_client_bootstrap_options(
            ...
            on_shutdown_complete: shutdownCallbackCore?.shutdown_callback_fn,
            user_data: shutdownCallbackCore?.shutdown_callback_user_data
        )
