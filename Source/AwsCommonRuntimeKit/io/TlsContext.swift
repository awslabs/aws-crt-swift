...
public final class TlsContextOptions {
  ...
  public func overrideDefaultTrustStore(ca: inout ByteCursor) throws {
    if (aws_tls_ctx_options_override_default_trust_store(&self.rawValue, &ca.rawValue) != AWS_OP_SUCCESS) {
      throw AwsCommonRuntimeError()
    }
  }
