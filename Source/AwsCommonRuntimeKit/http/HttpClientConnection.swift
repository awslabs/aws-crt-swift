...
public class HttpClientConnection {
    ...
    func onIncomingHeaders(_ stream: UnsafeMutablePointer<aws_http_stream>?,  _ headerBlock: aws_http_header_block, _ headerArray: UnsafePointer<aws_http_header>?, _ headersCount: Int,  _ userData: UnsafeMutableRawPointer!) -> Int32 {
    ...
    func onIncomingHeadersBlockDone(_ stream: UnsafeMutablePointer<aws_http_stream>?, _ headerBlock: aws_http_header_block, _ userData: UnsafeMutableRawPointer!) -> Int32 {
        let httpStreamCbData: HttpStreamCallbackData = Unmanaged.fromOpaque(userData).takeUnretainedValue()
        httpStreamCbData.requestOptions.onIncomingHeadersBlockDone(httpStreamCbData.stream!, headerBlock.headerBlock)
        return 0
    }

    func onIncomingBody(_ stream: UnsafeMutablePointer<aws_http_stream>?, _ data: UnsafePointer<aws_byte_cursor>?, _ userData: UnsafeMutableRawPointer!) -> Int32 {
        let httpStreamCbData: HttpStreamCallbackData = Unmanaged.fromOpaque(userData).takeUnretainedValue()
    ...
    func onStreamCompleted(_ stream: UnsafeMutablePointer<aws_http_stream>?, _ errorCode: Int32, _ userData: UnsafeMutableRawPointer!) {
    ...
    func onClientConnectionSetup(_ unmanagedConnection: UnsafeMutablePointer<aws_http_connection>!, _ errorCode: Int32, _ userData: UnsafeMutableRawPointer!) {
    ...
    func onClientConnectionShutdown(_ unmanagedConnection: UnsafeMutablePointer<aws_http_connection>?, _ errorCode: Int32, _ userData: UnsafeMutableRawPointer!) {
        let callbackData: HttpClientConnectionCallbackData = Unmanaged.fromOpaque(userData).takeRetainedValue()
