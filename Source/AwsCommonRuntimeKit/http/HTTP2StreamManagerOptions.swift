  ...
  func withCStruct<Result>(
    ...
    return hostName.withByteCursor { hostNameCursor in
      return withOptionalCStructPointer(
        ...
        proxyPointer, proxyEnvSettingsPointer, socketPointer,
        ...
        cStreamManagerOptions.shutdown_complete_user_data =
          shutdownOptions.shutdown_callback_user_data
        ...
        cStreamManagerOptions.ideal_concurrent_streams_per_connection =
          idealConcurrentStreamsPerConnection ?? 0
        cStreamManagerOptions.max_concurrent_streams_per_connection =
