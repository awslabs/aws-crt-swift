...
public struct CognitoLoginPair: CStruct {
  ...
  func withCStruct<Result>(_ body: (aws_cognito_identity_provider_token_pair) -> Result) -> Result {
    ...
    ) { identityProviderNameCursor, IdentityProviderTokenCursor in
...
public class CredentialsProvider: CredentialsProviding, @unchecked Sendable {
  ...
  public func getCredentials() async throws -> Credentials {
    return try await withCheckedThrowingContinuation {
      (continuation: CheckedContinuation<Credentials, Error>) in
...
extension CredentialsProvider {
  ...
  public convenience init(
    ...
    var options = aws_credentials_provider_delegate_options(
...
extension CredentialsProvider.Source {
  ...
  public static func `static`(
    ...
    Self {
      ...
      staticOptions.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()
      guard
        let provider: UnsafeMutablePointer<aws_credentials_provider> = withByteCursorFromStrings(
          accessKey,
          secret,
          sessionToken,
          accountId,
  ...
  public static func `environment`(shutdownCallback: ShutdownCallback? = nil) -> Self {
    ...
    Self {
      ...
      envOptions.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()
      guard
        let provider = aws_credentials_provider_new_environment(
          allocator.rawValue,
          &envOptions)
      else {
        shutdownCallbackCore.release()
  ...
  public static func `profile`(
    ...
    Self {
      ...
      profileOptionsC.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()
  ...
  public static func `process`(
    ...
    Self {
      ...
      processOptionsC.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()
  ...
  public static func `imds`(
    ...
    Self {
      ...
      imdsOptions.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()
      guard
        let provider = aws_credentials_provider_new_imds(
          allocator.rawValue,
          &imdsOptions)
      else {
        shutdownCallbackCore.release()
  ...
  public static func `cached`(
    ...
    Self {
      ...
      cachedOptions.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()

      guard let provider = aws_credentials_provider_new_cached(allocator.rawValue, &cachedOptions)
      else {
        shutdownCallbackCore.release()
        throw CommonRunTimeError.crtError(CRTError.makeFromLastError())
      }
  ...
  /// - Returns: `CredentialsProvider`
  /// - Throws: CommonRuntimeError.crtError
  public static func `defaultChain`(
    bootstrap: ClientBootstrap,
    fileBasedConfiguration: FileBasedConfiguration,
    ...
    Self {
      ...
      chainDefaultOptions.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()
      chainDefaultOptions.tls_ctx = tlsContext?.rawValue

      guard
        let provider = aws_credentials_provider_new_chain_default(
          allocator.rawValue,
          &chainDefaultOptions)
      else {
        shutdownCallbackCore.release()
      ...
      guard
        let provider: UnsafeMutablePointer<aws_credentials_provider> = withByteCursorFromStrings(
          ...
          { regionCursor, roleArnCursor, roleSessionNameCursor, tokenFilePathCursor in
            ...
            return aws_credentials_provider_new_sts_web_identity(
              allocator.rawValue,
              &stsOptions)
          })
      else {
    ...
    Self {
      ...
      guard
        let provider: UnsafeMutablePointer<aws_credentials_provider> = withByteCursorFromStrings(
          roleArn,
          sessionName,
          { roleArnCursor, sessionNameCursor in
            stsOptions.role_arn = roleArnCursor
      ...
      guard
        let provider: UnsafeMutablePointer<aws_credentials_provider> =
          (withByteCursorFromStrings(
            ...
            authToken,
            pathAndQuery
          ) { hostCursor, authTokenCursor, pathAndQueryCursor in
  ...
  public static func `cognito`(
    ...
    Self {
      ...
      let shutdownCallbackCore = ShutdownCallbackCore(shutdownCallback)
      cognitoOptions.shutdown_options =
        shutdownCallbackCore.getRetainedCredentialProviderShutdownOptions()
      ...
      guard
        let provider: UnsafeMutablePointer<aws_credentials_provider> =
          (withByteCursorFromStrings(
            endpoint,
            identity
          ) { endpointCursor, identityCursor in
            ...
            return withOptionalCStructPointer(to: proxyOptions) { proxyOptionsPointer in
              ...
              return logins.withAWSArrayList { loginArrayPointer in
                cognitoOptions.logins = UnsafeMutablePointer<
                ...
                return withOptionalByteCursorPointerFromString(
                  customRoleArn,
                  { customRoleArnCursor in
                    if let customRoleArnCursor {
                      cognitoOptions.custom_role_arn = UnsafeMutablePointer<aws_byte_cursor>(
                        mutating: customRoleArnCursor)
                    }
                    return aws_credentials_provider_new_cognito_caching(
                      allocator.rawValue, &cognitoOptions)
                  })
              }
            }
          })
...
private func onGetCredentials(
  credentials: OpaquePointer?,
  errorCode: Int32,
  userData: UnsafeMutableRawPointer!
) {

  let continuationCore = Unmanaged<ContinuationCore<Credentials>>.fromOpaque(userData)
    .takeRetainedValue()
...
private func getCredentialsDelegateFn(
  ...
  Task {
    do {
      ...
      callbackFn(
        nil, Int32(AWS_AUTH_CREDENTIALS_PROVIDER_DELEGATE_FAILURE.rawValue), userData.pointer)
    }
  }
