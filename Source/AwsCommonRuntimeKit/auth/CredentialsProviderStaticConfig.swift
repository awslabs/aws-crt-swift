...
class CredentialsProviderStaticConfigOptions {
    ...
    public init(accessKey: String,
        ...
        pointer.pointee = aws_credentials_provider_static_options(shutdown_options: shutDownOptions.rawValue.pointee, access_key_id: accessKey.awsByteCursor, secret_access_key: secret.awsByteCursor, session_token: sessionToken.awsByteCursor)
