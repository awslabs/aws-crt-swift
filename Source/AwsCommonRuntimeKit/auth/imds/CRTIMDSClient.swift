...
public class CRTIMDSClient {
    ...
    public func getResource(resourcePath: String) async throws -> String? {
        try await withCheckedThrowingContinuation { (continuation: ResourceContinuation) in
    ...
    public func getAncestorAmiIDs() async throws -> [String]? {
        try await withCheckedThrowingContinuation { (continuation: ArrayContinuation) in
    ...
    public func getCredentials(iamRoleName: String) async throws -> CRTCredentials {
        try await withCheckedThrowingContinuation { (continuation: CredentialsContinuation) in
    ...
    public func getIAMProfile() async throws -> CRTIAMProfile? {
        try await withCheckedThrowingContinuation { (continuation: IAMProfileContinuation) in
    ...
    public func getInstanceInfo() async throws -> CRTIMDSInstanceInfo? {
        try await withCheckedThrowingContinuation { (continuation: InstanceInfoContinuation) in
