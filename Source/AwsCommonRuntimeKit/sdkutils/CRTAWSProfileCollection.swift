...
public class CRTAWSProfileCollection {
    ...
    public init(fromFile path: String, source: CRTAWSProfileSourceType, allocator: Allocator = defaultAllocator) {
    ...
    public init(fromBuffer buffer: ByteBuffer, source: CRTAWSProfileSourceType, allocator: Allocator = defaultAllocator) {
        ...
        self.rawValue = aws_profile_collection_new_from_buffer(allocator.rawValue, pointer, source.rawValue)
    ...
    public init(fromMerge configProfileCollection: CRTAWSProfileCollection,
        ...
        self.rawValue = aws_profile_collection_new_from_merge(allocator.rawValue, configProfileCollection.rawValue, credentialPofileCollection.rawValue)
    }
    ...
    public func getProfile(name: String, profileCollection: CRTAWSProfileCollection, allocator: Allocator = defaultAllocator) -> CRTAWSProfile? {
        ...
        guard let profilePointer = aws_profile_collection_get_profile(profileCollection.rawValue, awsString.rawValue) else {
            return nil
        }
