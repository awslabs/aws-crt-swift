  ...
  func testCreateHttpClientOptions() throws {
    ...
    let httpClientOptions = HTTPClientConnectionOptions(
      ...
      monitoringOptions: HTTPMonitoringOptions(
        minThroughputBytesPerSecond: 10, allowableThroughputFailureInterval: 3),
      maxConnections: 10,
    ...
    httpClientOptions.withCStruct(shutdownOptions: shutdownOptions) { clientOptions in
      ...
      XCTAssertEqual(
        clientOptions.proxy_ev_settings.pointee.env_var_type, HTTPProxyEnvType.disable.rawValue)
      ...
      XCTAssertEqual(
        clientOptions.monitoring_options.pointee.minimum_throughput_bytes_per_second, 10)
