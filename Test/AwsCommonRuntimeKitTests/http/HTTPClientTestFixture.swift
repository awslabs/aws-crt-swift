...
class HTTPClientTestFixture: XCBaseTestCase {
    ...
    static func getHttpConnectionManager(
        endpoint: String,
        ssh: Bool = true,
        port: Int = 443,
        ...
        socketOptions: SocketOptions = SocketOptions(socketType: .stream)
    ...
    static func getHTTPRequestOptions(
        method: String,
        endpoint: String,
        path: String,
        body: String = "",
        ...
        let httpRequest: HTTPRequest = try HTTPRequest(
            method: method, path: path,
            body: useChunkedEncoding ? nil : ByteBuffer(data: body.data(using: .utf8)!))
        ...
        if useChunkedEncoding {
            ...
            httpRequest.addHeader(
                header: HTTPHeader(name: "Content-Length", value: String(body.count)))
        }
    ...
    static func getHTTP2RequestOptions(
        method: String,
        path: String,
        scheme: String = "https",
        authority: String,
