...
class AWSCredentialsTests: CrtXCBaseTestCase {
    ...
    func testCreateAWSCredentials() async throws {
        ...
        let credentials = try Credentials(accessKey: accessKey, secret: secret, sessionToken: sessionToken, expirationTimeout: expirationTimeout)
    ...
    func testCreateAWSCredentialsWithoutSessionToken() async throws {
        ...
        let credentials = try Credentials(accessKey: accessKey, secret: secret, sessionToken: nil, expirationTimeout: expirationTimeout)
    ...
    func testCreateAWSCredentialsWithoutAccessKeyThrows() async {
        ...
        XCTAssertThrowsError(try Credentials(accessKey: accessKey, secret: secret, sessionToken: nil, expirationTimeout: expirationTimeout))
    }
}
