...
class ChunkSignerTests: XCBaseTestCase {
  ...
  let expectedFirstChunkSignature =
    "ad80c730a21e5b8d04586a2213dd63b9a0e99e0e2307b0ade35a65485a288648"
  let expectedSecondChunkSignature =
    "0055627c9e194cb4542bae2aa5492e3c1575bbb81b612b7d234b86a503ef5497"
  let expectedFinalChunkSignature =
    "b6c6ea8a5354eaf15b3cb7646744f4275b71ea724fed81ceb9323e279d449df9"
  let expectedTrailerHeaderSignature =
  ...
  func testChunkedSigv4ASigning() async throws {
    let request = makeChunkedRequest()
    let signedRequest = try await Signer.signRequest(
      request: request, config: makeChunkedRequestSigningConfig(sigv4: false))
