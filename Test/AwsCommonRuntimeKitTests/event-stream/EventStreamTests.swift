...
class EventStreamTests: XCBaseTestCase {
  ...
  func testEncodeDecodeHeaders() async throws {
    ...
    let headers = [
      ...
      EventStreamHeader(name: "host", value: .string(value: "aws-crt-test-stuff.s3.amazonaws.com")),
      EventStreamHeader(
        name: "headerWithUtf8Character🧐", value: .string(value: "testValueWithEmoji🤯")),
      EventStreamHeader(name: "bool", value: .bool(value: false)),
      EventStreamHeader(
        name: "timestamp", value: .timestamp(value: Date(timeIntervalSinceNow: 10))),
      EventStreamHeader(
        name: "uuid", value: .uuid(value: UUID(uuidString: "63318232-1C63-4D04-9A0C-6907F347704E")!)
      ),
    ]
