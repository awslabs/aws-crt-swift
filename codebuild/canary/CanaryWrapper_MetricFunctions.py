...
def get_metric_total_cpu_usage(psutil_process: psutil.Process):
    ...
    try:
        ...
        print("ERROR - exception occurred gathering metrics for cpu usage!")
...
def get_metric_total_memory_usage_value(psutil_process: psutil.Process):
    try:
        ...
        print("ERROR - exception occurred gathering metrics for memory usage value!")
        print("Exception: " + str(e), flush=True)
        return None
...
def get_metric_total_memory_usage_percent(psutil_process: psutil.Process):
    try:
        ...
        print("ERROR - exception occurred gathering metrics for memory usage percentage!")
        print("Exception: " + str(e), flush=True)
        return None
